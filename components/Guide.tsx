...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      ...
      padding-container w-full pb-32'>
        <Image
          src='camp.svg'
          alt='camp'
          width={50}
        ...
        <div className='flex flex-wrap justify-between gap-5 lg:gap-10'>
          ...
          <p>Only with the hilink application you will no longer get lost and get lost again,
      ...
      <div className='flexCenter max-container w-full relative'>
        ...
        rounded-3xl border shadow-md md:left-[5%] lg:top-20px'>
          <Image
            src="/meter.svg"
            alt='meter'
            width={16}
