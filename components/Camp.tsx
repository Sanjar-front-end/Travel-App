...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CamprProps) => {
  return (
    ...
    bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
      ...
      p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16 text-white lg:bold-20">{peopleJoined}</p>
        </div>
      </div>
    </div>
  )
    ...
    flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className="flexEnd px-6 mt-10 lg:-mt-60 lg:-mr-6">
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="text-white xl:regular-16 mt-5">
